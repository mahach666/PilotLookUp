...
namespace PilotLookUp.UI.Utils
{
    public class SvgToPngConverter : ISvgToPngConverter
    {
        public BitmapImage GetBitmapImageBySvg(string svgIcon)
        {
            // TODO: Implement string-based SVG conversion
            return null;
        }

...
namespace PilotLookUp.Objects.Strategies
{
    public class StringWrapStrategy : ITypeWrapStrategy
    {
        ...
        public IPilotObjectHelper Wrap(object obj, TypeWrapContext context) => _factory.CreateString((string)obj);
    }
    ...
    public class IntWrapStrategy : ITypeWrapStrategy
    {
        ...
        public IPilotObjectHelper Wrap(object obj, TypeWrapContext context) => _factory.CreateInt((int)obj, context.ObjectsRepository, context.SenderObj, context.SenderMember);
    }
    ...
    public class BoolWrapStrategy : ITypeWrapStrategy
    {
        ...
        public IPilotObjectHelper Wrap(object obj, TypeWrapContext context) => _factory.CreateBool((bool)obj);
    }
    ...
    public class LongWrapStrategy : ITypeWrapStrategy
    {
        ...
        public IPilotObjectHelper Wrap(object obj, TypeWrapContext context) => _factory.CreateLong((long)obj);
    }
    ...
    public class DateTimeWrapStrategy : ITypeWrapStrategy
    {
        ...
        public IPilotObjectHelper Wrap(object obj, TypeWrapContext context) => _factory.CreateDateTime((DateTime)obj);
    }
    ...
    public class EnumWrapStrategy : ITypeWrapStrategy
    {
        ...
        public IPilotObjectHelper Wrap(object obj, TypeWrapContext context) => _factory.CreateEnum((Enum)obj);
    }
    ...
    public class GuidWrapStrategy : ITypeWrapStrategy
    {
        ...
        public IPilotObjectHelper Wrap(object obj, TypeWrapContext context) => _factory.CreateGuid((Guid)obj);
    }
    ...
    public class NullWrapStrategy : ITypeWrapStrategy
    {
        ...
        public IPilotObjectHelper Wrap(object obj, TypeWrapContext context) => _factory.CreateNull();
    }
} 